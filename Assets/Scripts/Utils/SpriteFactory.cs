...
public static class SpriteFactory {
  public static Sprite CreateDiscSprite(Color color, int size=16){
    ...
    var clear=new Color32(0,0,0,0); var r=size/2; var r2=r*r;
    for(var y=0;y<size;y++) for(var x=0;x<size;x++){ int dx=x-r, dy=y-r; tex.SetPixel(x,y,(dx*dx+dy*dy<=r2)?c:clear); }
