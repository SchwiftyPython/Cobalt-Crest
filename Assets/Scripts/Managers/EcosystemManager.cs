...
public class EcosystemManager : MonoBehaviour {
  ...
  public void Increment(string k){ if(!_counts.ContainsKey(k)) _counts[k]=0; _counts[k]++; }
  public void Decrement(string k){ if(!_counts.ContainsKey(k)) _counts[k]=0; _counts[k]=Mathf.Max(0,_counts[k]-1); }
