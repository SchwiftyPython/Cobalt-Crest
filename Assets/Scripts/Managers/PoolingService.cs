...
namespace Managers
{
    public class PoolingService : MonoBehaviour
    {
        ...
        private readonly Stack<Producer> _prod = new();
        private readonly Stack<Herbivore> _herb = new();
        private readonly Stack<Carnivore> _carn = new();
        ...
        public void Despawn(Producer p)
        {
            if (!UsePooling)
            {
                if (p != null)
        ...
        public void Despawn(Herbivore h)
        {
            if (!UsePooling)
            {
                if (h != null)
        ...
        public void Despawn(Carnivore c)
        {
            if (!UsePooling)
            {
                if (c != null)
