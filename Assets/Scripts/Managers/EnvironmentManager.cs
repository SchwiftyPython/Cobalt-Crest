...
public class EnvironmentManager : MonoBehaviour {
  ...
  void Update(){
    var dt = Time.deltaTime * Mathf.Max(0.0001f, EcosystemManager.SimulationSpeed); _t += dt;
    var env = ConfigService.Instance?.Env; var yearLen = env!=null? Mathf.Max(0.01f, env.yearLengthSeconds):120f; var season = (_t % yearLen)/yearLen;
